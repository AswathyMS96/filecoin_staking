          ...
          <Tooltip id="my-tooltip1"/>
            ...
            <div >
                {!isConnected ? (
                    ...
                    <button   onClick={connectWallet} className=" p-2 w-[250px] h-[70px]">Connect MetaMask</button><br/><br/>
                    <a href="https://link.foxwallet.com/wallet" target="_blank" ><button className=" p-2 w-[250px] h-[70px] ">FoxWallet</button></a>
